// Componente React con estilo Widget: Ink

// Algunas de las propiedades que el Ink de Flutter puede tener:
// - color
// - child
// - onTap
// - onDoubleTap
...
//             <Ink
//                 onTap={() => alert('Ink presionado!')}
//                 onHover={(e) => console.log('Cursor sobre Ink')}
